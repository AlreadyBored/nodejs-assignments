...
- File System (src/fs)
    ...
    - **+8** `list.js` implemented properly (including `name` and `sizeKB` properties)
...
- Streams (src/streams)
    ...
    - **+12** `transform.js` implemented properly
- Zlib (src/zip)
...
- Worker Threads (src/wt)
    ...
    - **+30** `main.js` implemented properly (creates correct number of workers, distributes ranges, collects results in order)
